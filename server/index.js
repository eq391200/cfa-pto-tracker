...
if (!process.env.SESSION_SECRET) {
  console.warn('WARNING: SESSION_SECRET not set in .env — using insecure fallback');
}
...
function scorecardAuth(req, res, next) {
  ...
  if (apiKey && process.env.SCORECARD_API_KEY && apiKey === process.env.SCORECARD_API_KEY) {
